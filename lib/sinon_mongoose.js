...
var Sandbox = require('sinon/lib/sinon/sandbox');
...
function makeChainable(mock, object, mockType) { // jshint ignore:line
...
function makeChainableVerify(mockResult) { // jshint ignore:line
...
function sandboxMock(object) {
  ...
  return this.add(mockResult); // jshint ignore:line
}
